...
.PHONY: run-nodump
run-nodump: app spike-trace $(BUILD_DIR)/applications/$(PROJECT)/main.mem
	@printf "\033[1;33m## Running the simulation...\033[0m\n"
	@python3 src/main.py --test_name $(BUILD_DIR)/applications/$(PROJECT)/spike-trace.log --mem_name $(BUILD_DIR)/main.mem
	@printf "\033[1;32m## Simulation completed!\033[0m\n"
